...
#line 29 "C:/gamedev/theforge/The-Forge/Common_3/Application/UI/Shaders/FSL/UI_ShaderList.fsl"
#line 1 "C:/gamedev/theforge/The-Forge/Common_3/Application/UI/Shaders/FSL/imgui.vert.fsl"
#line 25 "C:/gamedev/theforge/The-Forge/Common_3/Application/UI/Shaders/FSL/imgui.vert.fsl"
...
RES(CBUFFER(UniformBlock), uniformBlockVS, UPDATE_FREQ_NONE, b0, binding = 0);
...
PS_INPUT VS_MAIN( VS_INPUT In )
{
	//INIT_MAIN;
	PS_INPUT Out;
	Out.pos = mul(uniformBlockVS.ProjectionMatrix, float4(In.pos.xy, 0.f, 1.f));
	Out.col = In.col;
	Out.uv = In.uv;
	return (Out);
}
#line 30 "C:/gamedev/theforge/The-Forge/Common_3/Application/UI/Shaders/FSL/UI_ShaderList.fsl"
