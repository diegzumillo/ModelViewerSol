...
#line 33 "C:/gamedev/theforge/The-Forge/Common_3/Application/UI/Shaders/FSL/UI_ShaderList.fsl"
#line 1 "C:/gamedev/theforge/The-Forge/Common_3/Application/UI/Shaders/FSL/textured_mesh.frag.fsl"
#line 25 "C:/gamedev/theforge/The-Forge/Common_3/Application/UI/Shaders/FSL/textured_mesh.frag.fsl"
...
float4 PS_MAIN( PsIn In ): SV_TARGET
{
	//INIT_MAIN;
	float4 Out;
	Out = SampleTex2D(uTex, uSampler, In.texcoord) * uRootConstants.color;
	return (Out);
}
#line 34 "C:/gamedev/theforge/The-Forge/Common_3/Application/UI/Shaders/FSL/UI_ShaderList.fsl"
