...
#line 7 "C:/gamedev/theforge/The-Forge/Common_3/Resources/AnimationSystem/Animation/Shaders/FSL/Animation_ShaderList.fsl"
#line 1 "C:/gamedev/theforge/The-Forge/Common_3/Resources/AnimationSystem/Animation/Shaders/FSL/joint.vert.fsl"
#line 30 "C:/gamedev/theforge/The-Forge/Common_3/Resources/AnimationSystem/Animation/Shaders/FSL/joint.vert.fsl"
STRUCT(UniformBlock)
{
...
VSOutput VS_MAIN(VSInput In, uint InstanceID : SV_INSTANCEID)
{
    //INIT_MAIN;
    VSOutput Out;
    float4x4 matWorld = uniformBlock.toWorld[InstanceID];
    ...
    float4x4 tempMat = uniformBlock.mvp;



    float4x4 tempViewMatrix = uniformBlock.viewMatrix;
    ...
    float4 pos = mul(uniformBlock.toWorld[InstanceID], float4(In.Position.xyz, 1.0f));
    float3 lightDir = normalize(uniformBlock.lightPosition.xyz - pos.xyz);
    Out.LightDirection = float4(lightDir,0.0f);

    return (Out);
}
#line 8 "C:/gamedev/theforge/The-Forge/Common_3/Resources/AnimationSystem/Animation/Shaders/FSL/Animation_ShaderList.fsl"
